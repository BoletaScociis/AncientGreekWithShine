...
*/
 ...
 [_FN2_LAYER] = KEYMAP( /* AltGr Depressed */
    KC_GESC, KC_NO, KC_NO, RALT(KC_F3), KC_NO, KC_NO, KC_NO, KC_NO, RALT(KC_F8), RALT(KC_F9), RALT(KC_F10), RALT(KC_F11), RALT(KC_F12), KC_BSPC,
...
/*
 ...
 [_FN3_LAYER] = KEYMAP( /* AltGr and LSFT depressed */
    KC_GESC, KC_NO, KC_NO, RALT(LSFT(KC_F3)), KC_NO, KC_NO, KC_NO, RALT(LSFT(KC_F7)), KC_NO, RALT(LSFT(KC_F9)), RALT(LSFT(KC_F10)), RALT(LSFT(KC_F11)), RALT(LSFT(KC_F12)), KC_BSPC,
...
layer_state_t layer_state_set_user(layer_state_t layer) {
  ...
  switch(get_highest_layer(layer)) {
    ...
    case _FN2_LAYER:
      ...
      color.p.blue = 0x00;
      color.p.alpha = 0xff; 
      color_disabled.p.red = 0xff; // configure
      color_disabled.p.green = 0;
      color_disabled.p.blue = 0;
    ...
    case _FN3_LAYER:
      ...
      color.p.blue = 0x00;
      color.p.alpha = 0xff;
      color_disabled.p.red = 0; // configure
      color_disabled.p.green = 0xff;
      color_disabled.p.blue = 0;
      color_disabled.p.alpha = 0xff; 
      break;
    case _FN4_LAYER:
