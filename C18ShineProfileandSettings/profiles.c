...
#define COOLBLUE      0x29B6F6
#define PINEGREEN     0x66BB6A
#define BURNTORANGE   0xff6600
#define DARKYELLOW    0xff9900

#define CBL COOLBLUE
#define PGR PINEGREEN
#define BUO BURNTORANGE
#define DKY DARKYELLOW
#define ___ 0

static const uint32_t BaseBlue_keycols[NUM_COLUMN * NUM_ROW] = {
};
...
static const uint32_t FN1Green_keycols[NUM_COLUMN * NUM_ROW] = {
};
...
static const uint32_t FN2Orange_keycols[NUM_COLUMN * NUM_ROW] = {
/*  ESC   1    2    3    4    5    6    7    8    9    0    -    +    BS */
    ___, ___, ___, BUO, ___, ___, ___, ___, BUO, BUO, BUO, BUO, BUO, BUO,
    BUO, BUO, BUO, BUO, BUO, BUO, BUO, ___, BUO, ___, BUO, BUO, BUO, BUO,
    ___, ___, BUO, BUO, BUO, BUO, BUO, BUO, BUO, ___, ___, ___, BUO,
    ___, BUO, BUO, BUO, BUO, BUO, ___, BUO, ___, ___, BUO, ___, 
    ___, ___, BUO, ___, ___,
};
void FN2Orange(led_t *currentKeyLedColors) {
    for (uint16_t i = 0; i < NUM_COLUMN * NUM_ROW; ++i) {
...
/*  ESC   1    2    3    4    5    6    7    8    9    0    -    +    BS */
    ___, ___, ___, ___, ___, ___, ___, ___, ___, DKY, DKY, DKY, DKY, DKY, 
    DKY, DKY, DKY, DKY, DKY, DKY, DKY,  DKY, DKY,  ___, ___, ___, ___,
    ___, ___, DKY,  DKY, ___, DKY, DKY, DKY,  ___, ___, ___, ___, ___,
    ___, DKY, DKY, DKY, DKY, ___, ___, DKY, ___, ___, DKY, ___, 
    ___, ___, DKY, ___, ___,
};
void FN3Yellow(led_t *currentKeyLedColors) {
    for (uint16_t i = 0; i < NUM_COLUMN * NUM_ROW; ++i) {
...
/*  ESC   1    2    3    4    5    6    7    8    9    0    -    +    BS */
    ...
    ___, ___, BUO, BUO, ___, ___, ___, ___, ___, ___, ___, BUO, ___, ___,
};
